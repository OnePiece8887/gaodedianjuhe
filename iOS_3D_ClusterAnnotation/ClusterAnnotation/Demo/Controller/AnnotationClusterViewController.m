...
- (void)updateMapViewAnnotationsWithAnnotations:(NSArray *)annotations
{
    ...
    /* 保留仍然位于屏幕内的annotation. 交集 */
    NSMutableSet *toKeep = [NSMutableSet setWithSet:before];
    [toKeep intersectSet:after];
    
    /* 需要添加的annotation. 去除共有的部分 */
    NSMutableSet *toAdd = [NSMutableSet setWithSet:after];
    [toAdd minusSet:toKeep];
    
    /* 删除位于屏幕外的annotation. 去除共有的部分 */
...
- (MAAnnotationView *)mapView:(MAMapView *)mapView viewForAnnotation:(id<MAAnnotation>)annotation
{
    ...
    if ([annotation isKindOfClass:[LSDAnnotation class]]) {
        /* dequeue重用annotationView. */
        static NSString *const imageAnnotatioViewReuseID = @"imageAnnotatioViewReuseID";
        LSDAnnotationView *annotionView = (LSDAnnotationView *)[mapView dequeueReusableAnnotationViewWithIdentifier:imageAnnotatioViewReuseID];
        
        if (annotionView == nil) {
            annotionView = [[LSDAnnotationView alloc]initWithAnnotation:annotation reuseIdentifier:imageAnnotatioViewReuseID];
        }
